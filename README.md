...
PNGTuber-приложение с TTS-озвучкой чата Twitch. Прозрачный оверлей поверх окон (для OBS Window Capture) с 2D-аватаром, который "говорит" под TTS-озвучку сообщений `!tts <текст>` из Twitch-чата.
